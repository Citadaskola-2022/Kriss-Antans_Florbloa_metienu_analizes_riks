<?php view('partials/header.view.php') ?>
                ...
                <div class="-space-y-px rounded-md shadow-sm">
                    <div>
                        ...
                        <?php if (isset($errors['email'])): ?>
                            <p class="text-red-500 text xs mt-2"><?= $errors['email']['email'] ?? '';  ?></p>
                        <?php endif; ?>
                    </div>
                    <div>
                    ...
                    <?php if (isset($errors['password'])): ?>
                        <p class="text-red-500 text xs mt-2"><?= $errors['password']['required'] ?? $errors['password']['min'] ?? ''; ?></p>
                    <?php endif; ?>
